  ...
  <body>
    ...
    <div id="form-box">
        ...
        <div class="button-group">
            <a href="changestatus1.php?id_order=<?php echo $_GET['id_order'];?>&ac=confirm"><button class="btn btn-newlist mr" >อนุมัติ</button></a>
            <a href="changestatus1.php?id_order=<?php echo $_GET['id_order'];?>&ac=noconfirm"><button class="btn btn-cancel mr" >ไม่อนุมัติ</button></a>
