  ...
  <body>
                ...
                <div class="content-profile">   
                    ...
                    <div class="content-detail">
                        <ul>
                            ...
                            <li>ฝ่าย/แผนก :<span><?php echo $objResult["Status"];?>
                            </span></li>
                        </ul>
                    </div>
                </div>           
    ...
    <div id="form-box">
            ...
            <div class="ctrl-content">
                <div class="bg-group">
                    <div class="sub-head-formpage">
                        <span>รายการขอเบิกค่าใช้จ่ายอุปกรณ์สำนักงาน</span>
        ...
        <div class="button-group">
            <a href="changestatus2.php?id_order=<?php echo $_GET['id_order'];?>&ac=confirm"><button class="btn btn-newlist mr" >อนุมัติ</button></a>
            <a href="changestatus2.php?id_order=<?php echo $_GET['id_order'];?>&ac=noconfirm"><button class="btn btn-cancel mr" >ไม่อนุมัติ</button></a>
